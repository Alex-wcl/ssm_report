    ...
    var app = {
        init:function(){
            ...
            document.addEventListener('DOMContentLoaded',function(){
                points = document.querySelectorAll('.viewport .pageview') ;
                points1 = document.querySelectorAll('.pagenumber div') ;
        ...
        setPageNow:function(){
            if (currentPoint != -1){
                $(points[currentPoint]).removeClass('now');
                points1[currentPoint].className = '';
            }
            currentPoint = pageNow - 1;
            $(points[currentPoint]).addClass('now');
            points1[currentPoint].className = 'cur';
        },
        ...
        bindTouchEvent:function(){
            ...
            document.addEventListener("touchmove",function(e){
                ...
                if (swipeX && Math.abs(deltaX) > Math.abs(deltaY)){
                    e.preventDefault();
                    moveLength = deltaX;
                ...
                }else if(swipeY && Math.abs(deltaX) < Math.abs(deltaY)){
                    //e.preventDefault();
